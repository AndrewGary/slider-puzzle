  ...
  return (
    <div className="flex flex-col w-full h-screen items-center justify-evenly bg-gradient-to-t from-blue-100 via-blue-300 to-blue-500">
      ...
      <div className="flex w-full justify-center">
        ...
        {selectedImage !== null ? <SolutionImage image={arrayOfImages[selectedImage]} setSelectedImage={setSelectedImage}/> : <ImageSelection setGameMessage={setGameMessage} setSelectedImage={setSelectedImage}/>}
      </div>
      <div className="w-1/2">
        <GameControls
